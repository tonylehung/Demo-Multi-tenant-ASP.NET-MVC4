...
namespace TenantURL.Controllers
{
    public class NewsController : Controller
    {
        ...
        private bool checkNull(TenantControl tc)
        {
            if (tc == null)
                return true;
            if (tc.Id == -1 || tc.TenantSchema != getTenantRouting())
                return true;
            return false;
        }
        private string getTenantRouting()
        {
        ...
        public ActionResult Index()
        {
            ...
            if (checkNull(tc)) return RedirectToAction("index", "home");
        ...
        public ActionResult Edit([Bind(Include = "Id,Title,Content,Created")] News news)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (tc == null) return RedirectToAction("index", "home");
